...
const BistroCover = () => {
    return (
        <div className="relative my-10 max-w-6xl mx-auto">
            <img src={chef} alt="" />
            <section className=' h-[90%] w-[90%] left-[5%] top-[5%] lg:h-[50%] md:h-[70%] md:w-[60%] lg:w-[40%] md:top-[15%] md:left-[20%] lg:top-[25%] lg:left-[30%] text-center bg-white absolute font-semibold '>
